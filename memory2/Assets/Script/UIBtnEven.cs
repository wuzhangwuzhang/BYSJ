...
public class UIBtnEven : MonoBehaviour
{
    ...
    void Update()
    {
        if (ConrastGObj.playDestoryNumber != 0)
        {
            PlayingTime();
    ...
    public void BtnOneClickEven()
    {
        ...
        CheckPosition();
        InstantiateCheck(6);
        ConrastGObj.playDestoryNumber = 6;
    ...
    public void BtnTwoClickEven()
    {
        ...
        ConrastGObj.playDestoryNumber = rowNumber;
        timeLevelLoad = Time.timeSinceLevelLoad; //此刻开始时间
    }

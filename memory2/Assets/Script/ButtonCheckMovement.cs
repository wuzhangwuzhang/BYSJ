...
public class ButtonCheckMovement : MonoBehaviour 
{
    ...
    void OpenPictureToRotate()
    {
        ...
        else if (transform.eulerAngles.y < 180 || transform.eulerAngles.y > -180)
        {
            ...
            if (ConrastGObj.checkObjOne == null)
            {
                ConrastGObj.checkObjOne = gameObject;
            }
            else if (ConrastGObj.checkObjTwo == null && ConrastGObj.checkObjOne != gameObject)
            {
                ConrastGObj.checkObjTwo = gameObject;
            }
        }
    }
